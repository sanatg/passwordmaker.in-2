...
$(function(){
	...
	$('#step2').on('change', '#encrypt-input', function(e){
		...
		if(file.size > 10024*10024){
			alert('Please choose files smaller than 10mb, otherwise window might crash');
			return;
		}
	...
	$('a.button.process').click(function(){
		...
		if(body.hasClass('encrypt')){
			...
			reader.onload = function(e){
				...
				var encrypted = encrypt(e.target.result,password);
			...
			reader.onload = function(e){
				...
				var decrypted = decrypt(e.target.result,password).toString(CryptoJS.enc.Utf8);
