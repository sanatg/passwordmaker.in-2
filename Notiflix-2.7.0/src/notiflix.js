...
(function (root, factory) {
  ...
  var notifySettings = {
    ...
    zindex: 4001,
    useGoogleFont: true, // v2.2.0 and the next versions => has been changed as "false"
...
Notiflix.Confirm.Init({className:'notiflix-confirm',width:'500px',zindex:4003,position:'center',distance:'10px',backgroundColor:'#f8f8f8',borderRadius:'25px',backOverlay:true,backOverlayColor:'rgba(0,0,0,0.5)',rtl:false,useGoogleFont:false,fontFamily:'Quicksand',cssAnimation:true,cssAnimationStyle:'fade',cssAnimationDuration:300,plainText:true,titleColor:'#32c682',titleFontSize:'16px',titleMaxLength:34,messageColor:'#1e1e1e',messageFontSize:'14px',messageMaxLength:110,buttonsFontSize:'15px',buttonsMaxLength:34,okButtonColor:'#f8f8f8',okButtonBackground:'#32c682',cancelButtonColor:'#f8f8f8',cancelButtonBackground:'#a9a9a9',});
    }
  ...
  var NotiflixLoading = function (messageOrOptions, options, iconType, display, delay) {
    ...
    if (!newLoadingSettings) {
     Notiflix.Loading.Init({className:'notiflix-loading',zindex:4000,backgroundColor:'rgba(255, 255, 255,1)',rtl:false,useGoogleFont:true,fontFamily:'Quicksand',cssAnimation:true,cssAnimationDuration:400,clickToClose:false,customSvgUrl:null,svgSize:'70px',svgColor:'#ff5757',messageID:'NotiflixLoadingMessage',messageFontSize:'13px',messageMaxLength:79,messageColor:'#000',});
    }
